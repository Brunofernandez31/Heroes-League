But du projet :
Progresser grâce à mes cours pour mettre à jour mon projet de location de Super Héros.

Etape 1 : 
Simple projet de reproduction d'une maquette donnée par IA
Exercice pour s'entrainer avec HTML + CSS
