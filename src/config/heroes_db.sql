...
VALUES 
    ...
    ('J''ai perdu mon alliance de mariage dans le parc il y a 3 mois. Ma femme pense que je l''ai vendue. Mon mariage est en jeu. Besoin d''un flair exceptionnel.', 
    'Nantes', 
    '2025-01-20', 
    '02:00:00', 
    1,
    ...
    ('Mon ex a cassé notre vase de la réconciliation lors de notre dernière dispute. Je veux le recoller avant qu''elle revienne chercher ses affaires demain. C''est symbolique.', 
    'Strasbourg', 
    '2025-01-19', 
    '01:30:00', 
    2,
    ...
    ('Je suis coincé dans une boucle administrative infernale avec les impôts depuis 6 mois. Ils me réclament une taxe d''habitation pour un appartement que je n''ai jamais habité.', 
    'Lille', 
    '2025-01-22', 
    '04:00:00', 
    3,
    ...
    ('Régime strict depuis 2 semaines, je n''arrive plus à... enfin vous voyez. Besoin d''aide d''urgence, mon ventre va exploser.', 
    'Marseille', 
    '2025-01-19', 
    '00:30:00', 
    4,
    ...
    ('Enfermé dans les toilettes de mon bureau depuis 2h, la poignée est cassée. Mon patron pense que je suis en télétravail. Besoin de sortir discrètement.', 
    'Paris', 
    '2025-01-19', 
    '01:00:00', 
    1,
    ...
    ('Déménagement urgent de ma collection de 847 pots de confiture artisanale du grenier au garage. Escalier en colimaçon très étroit. Fragile !!', 
    'Toulouse', 
    '2025-01-21', 
    '05:00:00', 
    2,
    ...
    ('Animation de l''anniversaire de ma fille de 8 ans. Thème : princesses licornes arc-en-ciel. Besoin de quelqu''un d''énergique et créatif. Les enfants sont... intenses.', 
    'Lyon', 
    '2025-01-25', 
    '03:00:00', 
    3,
    ...
    ('Recherche personne ayant vécu les années 40-50 pour raconter des anecdotes historiques à mon grand-père de 95 ans. Il s''ennuie et refuse de regarder la télé.', 
    'Bordeaux', 
    '2025-01-23', 
    '02:00:00', 
    4,
    ...
    ('Rupture difficile après 7 ans de relation. Besoin de présence réconfortante pour m''empêcher de rappeler mon ex. Juste besoin de quelqu''un qui écoute (ou ronronne).', 
    'Nice', 
    '2025-01-20', 
    '04:00:00', 
    1,
    ...
    ('Guerre de voisinage : son lierre envahit mon jardin depuis 3 ans. Besoin de stratégie botanique pour reprendre le contrôle sans déclencher la 3ème guerre mondiale.', 
    'Rennes', 
    '2025-01-24', 
    '02:30:00', 
    2,
    ...
    ('Besoin de déplacer mon jacuzzi du salon (longue histoire) vers la terrasse. Objet lourd + passages de porte compliqués. Attention à ne pas rayer le parquet.', 
    'Montpellier', 
    '2025-01-26', 
    '03:30:00', 
    3,
    ...
    ('Mon coloc vole mes plats dans le frigo depuis des mois. Je veux coller sa main sur le frigo la prochaine fois qu''il l''ouvre. Juste 48h pour la leçon.', 
    'Paris', 
    '2025-01-21', 
    '01:00:00', 
    4,
    ...
    ('Coincé dans un escape game depuis 4h. Les employés sont partis. Je ne trouve pas la dernière énigme. Mon téléphone est à 2%. À L''AIDE.', 
    'Lyon', 
    '2025-01-19', 
    '01:30:00', 
    1,
    ...
    ('Mon chat est parti depuis 5 jours. Il répond au nom de "Monsieur Moustache". Dernier vu près de la boulangerie. Ma fille pleure tous les soirs.', 
    'Nantes', 
    '2025-01-22', 
    '06:00:00', 
    2,
    ...
    ('Besoin de quelqu''un pour : repeindre mon salon, garder mes 2 enfants, ET signer les papiers du déménagement demain. Je suis débordé. Tout doit être fait en même temps.', 
    'Marseille', 
    '2025-01-20', 
    '05:00:00', 
    3,
